...
namespace Auction_Management_System
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            //select multiple rows without procudure
            ...
            cmd.Connection = conn;
            // select multiple rows using procudure using refcursor
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            OracleCommand cmd = new OracleCommand();
            cmd.Connection = conn;
            //Select one row using stored procedure (connnected mode)
        ...
        private void itemID_cmp_SelectedIndexChanged(object sender, EventArgs e)
        {
